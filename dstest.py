...
def disco_choice(environ, start_response):
    resp = Response(mako_template="discosrv.mako", template_lookup=LOOKUP,
                    headers=[])
    argv = {"dslist": ARGS["disco_srvs"]}
...
def application(environ, start_response):
    ...
    if path == "":
        return disco_choice(environ, start_response)
